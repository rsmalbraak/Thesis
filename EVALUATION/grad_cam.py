""" 
Code necessary to create Grad-CAM visualizations of the decision process of CNNs. 
We did not modify this code, and it is directly from:
https://github.com/kazuto1011/grad-cam-pytorch

This code is imported in create_gradcam.py
